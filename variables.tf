...
locals {
  ...
  workers_group_defaults_defaults = {
    ...
    subnets                       = "${join(",", data.aws_subnet_ids.cluster_internal_subnet.ids)}" # A comma delimited string of subnets to place the worker nodes in. i.e. subnet-123,subnet-456,subnet-789
